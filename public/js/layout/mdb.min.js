function dropdownEffectData(t) {
    var e = null,
        ...
        o = $(".dropdown-menu", t),
        s = n.parents("ul.nav");
    return s.height > 0 && (e = s.data("dropdown-in") || null, i = s.data("dropdown-out") || null), {
        target: t,
        dropdown: n,
        dropdownMenu: o,
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function(t, e, i, n, o) {
            ...
            return e < 1 ? -.5 * (r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * o - s) * (2 * Math.PI) / a)) + i : r * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * o - s) * (2 * Math.PI) / a) * .5 + n + i
        },
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (! function(t) {
        ...
        if (!t.jQuery) {
            ...
            i.isWindow = function(t) {
                ...
                if (n) {
                    if (r)
                        for (; a > s && (o = i.apply(t[s], n), o !== !1); s++);
                    else
                        for (s in t)
                            if (o = i.apply(t[s], n), o === !1) break
                } else if (r)
                    for (; a > s && (o = i.call(t[s], s, t[s]), o !== !1); s++);
                else
                    for (s in t)
                ...
                var o = t[i.expando],
                    s = o && n[o];
                s && i.each(e, function(t, e) {
                    delete s[e]
                })
            }, i.extend = function() {
                var t, e, n, o, s, a, r = arguments[0] || {},
                    l = 1,
                    c = arguments.length,
                    h = !1;
                for ("boolean" == typeof r && (h = r, r = arguments[l] || {}, l++), "object" != typeof r && "function" !== i.type(r) && (r = {}), l === c && (r = this, l--); c > l; l++)
                    if (null != (s = arguments[l]))
                        for (o in s) t = r[o], n = s[o], r !== n && (h && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, a = t && i.isArray(t) ? t : []) : a = t && i.isPlainObject(t) ? t : {}, r[o] = i.extend(h, a, n)) : void 0 !== n && (r[o] = n));
                return r
                ...
                if (t) {
                    n = (n || "fx") + "queue";
                    var a = i.data(t, n);
                    return o ? (!a || i.isArray(o) ? a = i.data(t, n, s(o)) : a.push(o), a) : a || []
                }
        ...
        return function(t, e, i, n) {
            ...
            function l(t, i, n, o) {
                ...
                function d(e, i, o) {
                    var s, a, r = 0;
                    do a = i + (o - i) / 2, s = l(a, t, n) - e, s > 0 ? o = a : i = a; while (Math.abs(s) > m && ++r < y);
                    return a
                }

                function p(e) {
                    for (var i = 0, o = 1, s = b - 1; o != s && k[o] <= e; ++o) i += w;
                    --o;
                    var a = (e - k[o]) / (k[o + 1] - k[o]),
                        r = i + a * w,
                        l = c(r, t, n);
                    return l >= v ? h(e, r) : 0 == l ? r : d(e, i, i + w)
                }
                ...
                var k = x ? new Float32Array(b) : new Array(b),
                    C = !1,
                    P = function(e) {
                        return C || f(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(p(e), i, o)
                    };
            ...
            function h(t) {
                if (t) {
                    ...
                    for (var s = 0; i > s; s++)
                        if (b.State.calls[s]) {
                            var r = b.State.calls[s],
                                l = r[0],
                                c = r[2],
                                p = r[3],
                                f = !!p,
                                v = null;
                            p || (p = b.State.calls[s][3] = e - 16);
                            for (var m = Math.min((e - p) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                                ...
                                if (a(C)) {
                                    ...
                                    for (var A in S)
                                        if ("element" !== A) {
                                            var E, L = S[A],
                                                M = g.isString(L.easing) ? b.Easings[L.easing] : L.easing;
                                            if (1 === m) E = L.endValue;
                                            else {
                                                var R = L.endValue - L.startValue;
                                                if (E = L.startValue + R * M(m, c, R), !f && E === L.currentValue) continue
                                            }
                                            if (L.currentValue = E, "tween" === A) v = E;
                                            else {
                                                if (x.Hooks.registered[A]) {
                                                    var O = x.Hooks.getRoot(A),
                                                        W = a(C).rootPropertyValueCache[O];
                                                    W && (L.rootPropertyValue = W)
                                                }
                                                var F = x.setPropertyValue(C, A, L.currentValue + (0 === parseFloat(E) ? "" : L.unitType), L.rootPropertyValue, L.scrollData);
                                                x.Hooks.registered[A] && (a(C).rootPropertyValueCache[O] = x.Normalizations.registered[O] ? x.Normalizations.registered[O]("extract", null, F[1]) : F[1]), "transform" === F[0] && (P = !0)
                                            }
                                        }
                                    c.mobileHA && a(C).transformCache.translate3d === n && (a(C).transformCache.translate3d = "(0px, 0px, 0px)", P = !0), P && x.flushTransformCache(C)
                                }
                            }
                            c.display !== n && "none" !== c.display && (b.State.calls[s][2].display = !1), c.visibility !== n && "hidden" !== c.visibility && (b.State.calls[s][2].visibility = !1), c.progress && c.progress.call(r[1], r[1], m, Math.max(0, p + c.duration - e), p, v), 1 === m && u(s)
                        }
                }
                b.State.isTicking && k(h)
            }

            function u(t, e) {
                if (!b.State.calls[t]) return !1;
                for (var i = b.State.calls[t][0], o = b.State.calls[t][1], s = b.State.calls[t][2], r = b.State.calls[t][4], l = !1, c = 0, h = i.length; h > c; c++) {
                    var u = i[c].element;
                    if (e || s.loop || ("none" === s.display && x.setPropertyValue(u, "display", s.display), "hidden" === s.visibility && x.setPropertyValue(u, "visibility", s.visibility)), s.loop !== !0 && (d.queue(u)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(u)[1])) && a(u)) {
                        a(u).isAnimating = !1, a(u).rootPropertyValueCache = {};
                        var p = !1;
                        d.each(x.Lists.transforms3D, function(t, e) {
                            var i = /^scale/.test(e) ? 1 : 0,
                                o = a(u).transformCache[e];
                            a(u).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (p = !0, delete a(u).transformCache[e])
                        }), s.mobileHA && (p = !0, delete a(u).transformCache.translate3d), p && x.flushTransformCache(u), x.Values.removeClass(u, "velocity-animating")
                    }
                    ...
                    r && s.loop !== !0 && r(o), a(u) && s.loop === !0 && !e && (d.each(a(u).tweensContainer, function(t, e) {
            ...
            var d, p = function() {
                ...
                v = !1;
            if (t.fn && t.fn.jquery ? (d = t, v = !0) : d = e.Velocity.Utilities, 8 >= p && !v) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            ...
            var w = function() {
                ...
                return function t(e, n, o) {
                    var s, a, r, l = {
                        ...
                        u = 1e-4,
                        d = .016;
                    for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, o = o || null, l.tension = e, l.friction = n, s = null !== o, s ? (h = t(e, n), a = h / o * d) : a = d; r = i(r || l, a), c.push(1 + r.x), h += 16, Math.abs(r.x) > u && Math.abs(r.v) > u;);
                    return s ? function(t) {
            ...
            var x = b.CSS = {
                ...
                Hooks: {
                    ...
                    register: function() {
                        ...
                        if (p)
                            for (i in x.Hooks.templates) {
                                ...
                                var s = n[1].match(x.RegEx.valueSplit);
                                "Color" === o[0] && (o.push(o.shift()), s.push(s.shift()), x.Hooks.templates[i] = [o.join(" "), s.join(" ")])
                            }
                        for (i in x.Hooks.templates) {
                            n = x.Hooks.templates[i], o = n[0].split(" ");
                            for (var t in o) {
                    ...
                    injectValue: function(t, e, i) {
                        ...
                        if (n) {
                            var o, s, a = n[0],
                                r = n[1];
                            return i = x.Hooks.cleanRootPropertyValue(a, i), o = i.toString().match(x.RegEx.valueSplit), o[r] = e, s = o.join(" ")
                        }
                        return i
                    }
                },
                                ...
                                switch (t) {
                                    ...
                                    case "inject":
                                        ...
                                        switch (e.substr(0, e.length - 1)) {
                                            ...
                                            case "scal":
                                            case "scale":
                                                b.State.isAndroid && a(i).transformCache[e] === n && 1 > o && (o = 1), s = !/(\d)$/i.test(o);
                                                break;
                                            case "skew":
                                                s = !/(deg|\d)$/i.test(o);
                                                break;
                                        ...
                                        return s || (a(i).transformCache[e] = "(" + o + ")"), a(i).transformCache[e]
                                }
                            }
                        }();
                        for (var t = 0; t < x.Lists.colors.length; t++) ! function() {
                            ...
                            x.Normalizations.registered[e] = function(t, i, o) {
                                switch (t) {
                                    ...
                                    case "extract":
                                        var s;
                                        if (x.RegEx.wrappedValueAlreadyExtracted.test(o)) s = o;
                                        else {
                                            var a, r = {
                                                black: "rgb(0, 0, 0)",
                                                blue: "rgb(0, 0, 255)",
                                            ...
                                            /^[A-z]+$/i.test(o) ? a = r[o] !== n ? r[o] : r.black : x.RegEx.isHex.test(o) ? a = "rgb(" + x.Values.hexToRgb(o).join(" ") + ")" : /^rgba?\(/i.test(o) || (a = r.black), s = (a || o).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                ...
                getPropertyValue: function(t, i, o, s) {
                    function r(t, i) {
                        ...
                        if (8 >= p) l = d.css(t, i);
                            ...
                            var c = !1;
                            if (/^(width|height)$/.test(i) && 0 === x.getPropertyValue(t, "display") && (c = !0, x.setPropertyValue(t, "display", x.Values.getDisplayType(t))), !s) {
                                if ("height" === i && "border-box" !== x.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
                                    var h = t.offsetHeight - (parseFloat(x.getPropertyValue(t, "borderTopWidth")) || 0) - (parseFloat(x.getPropertyValue(t, "borderBottomWidth")) || 0) - (parseFloat(x.getPropertyValue(t, "paddingTop")) || 0) - (parseFloat(x.getPropertyValue(t, "paddingBottom")) || 0);
                                    return o(), h
                                }
                            ...
                            var f;
                            f = a(t) === n ? e.getComputedStyle(t, null) : a(t).computedStyle ? a(t).computedStyle : a(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), l = 9 === p && "filter" === i ? f.getPropertyValue(i) : f[i], ("" === l || null === l) && (l = t.style[i]), o()
                        }
                    ...
                    if (x.Hooks.registered[i]) {
                        var c = i,
                            h = x.Hooks.getRoot(c);
                        o === n && (o = x.getPropertyValue(t, x.Names.prefixCheck(h)[0])), x.Normalizations.registered[h] && (o = x.Normalizations.registered[h]("extract", t, o)), l = x.Hooks.extractValue(c, o)
                    } else if (x.Normalizations.registered[i]) {
                        var u, f;
                        u = x.Normalizations.registered[i]("name", t), "transform" !== u && (f = r(t, x.Names.prefixCheck(u)[0]), x.Values.isCSSNullValue(f) && x.Hooks.templates[i] && (f = x.Hooks.templates[i][1])), l = x.Normalizations.registered[i]("extract", t, f)
                    }
                    if (!/^[\d-]/.test(l))
                ...
                setPropertyValue: function(t, i, n, o, s) {
                    ...
                    if ("scroll" === i) s.container ? s.container["scroll" + s.direction] = n : "Left" === s.direction ? e.scrollTo(n, s.alternateValue) : e.scrollTo(s.alternateValue, n);
                    else if (x.Normalizations.registered[i] && "transform" === x.Normalizations.registered[i]("name", t)) x.Normalizations.registered[i]("inject", t, n), r = "transform", n = a(t).transformCache[i];
                    else {
                        if (x.Hooks.registered[i]) {
                            var l = i,
                                c = x.Hooks.getRoot(i);
                        ...
                        } else a(t) && a(t).isSVG && x.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[r] = n;
                ...
                flushTransformCache: function(t) {
                    ...
                    if ((p || b.State.isAndroid && !b.State.isChrome) && a(t).isSVG) {
                        ...
                        d.each(a(t).transformCache, function(e) {
                            return o = a(t).transformCache[e], "transformPerspective" === e ? (s = o, !0) : (9 === p && "rotateZ" === e && (e = "rotate"), void(i += e + o + " "))
                        }), s && (i = "perspective" + s + " " + i)
                    }
            ...
            x.Hooks.register(), x.Normalizations.register(), b.hook = function(t, e, i) {
                ...
                return t = s(t), d.each(t, function(t, s) {
                    if (a(s) === n && b.init(s), i === n) o === n && (o = b.CSS.getPropertyValue(s, e));
                    else {
                        var r = b.CSS.setPropertyValue(s, e, i);
                        "transform" === r[0] && b.CSS.flushTransformCache(s), o = r
                    }
                }), o
            };
            var S = function() {
                ...
                function o() {
                    function t(t) {
                        function u(t, e) {
                            var i = n,
                                o = n,
                                a = n;
                            return g.isArray(t) ? (i = t[0], !g.isArray(t[1]) && /^[\d-]/.test(t[1]) || g.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? a = t[1] : (g.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || g.isArray(t[1])) && (o = e ? t[1] : c(t[1], r.duration), t[2] !== n && (a = t[2]))) : i = t, e || (o = o || r.easing), g.isFunction(i) && (i = i.call(s, C, k)), g.isFunction(a) && (a = a.call(s, C, k)), [i || 0, o, a]
                        }
                        ...
                        function m() {
                            ...
                            if (o && n) l.emToPx = F.lastEmToPx, l.percentToPxWidth = F.lastPercentToPxWidth, l.percentToPxHeight = F.lastPercentToPxHeight;
                                ...
                                var c = a(s).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                            ...
                            return null === F.remToPx && (F.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === F.vwToPx && (F.vwToPx = parseFloat(e.innerWidth) / 100, F.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = F.remToPx, l.vwToPx = F.vwToPx, l.vhToPx = F.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), s), l
                        }
                        if (r.begin && 0 === C) try {
                            r.begin.call(f, f)
                        } catch (t) {
                        ...
                        if ("scroll" === E) {
                            var w, S, P, T = /^x$/i.test(r.axis) ? "Left" : "Top",
                                L = parseFloat(r.offset) || 0;
                            r.container ? g.isWrapped(r.container) || g.isNode(r.container) ? (r.container = r.container[0] || r.container, w = r.container["scroll" + T], P = w + d(s).position()[T.toLowerCase()] + L) : r.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + T]], S = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]], P = d(s).offset()[T.toLowerCase()] + L), l = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: w,
                                    currentValue: w,
                            ...
                            if (!a(s).tweensContainer) return void d.dequeue(s, r.queue);
                            "none" === a(s).opts.display && (a(s).opts.display = "auto"), "hidden" === a(s).opts.visibility && (a(s).opts.visibility = "visible"), a(s).opts.loop = !1, a(s).opts.begin = null, a(s).opts.complete = null, y.easing || delete r.easing, y.duration || delete r.duration, r = d.extend({}, a(s).opts, r);
                            var M = d.extend(!0, {}, a(s).tweensContainer);
                            for (var R in M)
                                if ("element" !== R) {
                                    var O = M[R].startValue;
                                    M[R].startValue = M[R].currentValue = M[R].endValue, M[R].endValue = O, g.isEmptyObject(y) || (M[R].easing = r.easing), b.debug && console.log("reverse tweensContainer (" + R + "): " + JSON.stringify(M[R]), s)
                                }
                            l = M
                        } else if ("start" === E) {
                            var M;
                            a(s).tweensContainer && a(s).isAnimating === !0 && (M = a(s).tweensContainer), d.each(v, function(t, e) {
                                if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (x.RegEx.isHex.test(o)) {
                                        for (var r = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), c = a ? x.Values.hexToRgb(a) : n, h = 0; h < r.length; h++) {
                                            var d = [l[h]];
                                            s && d.push(s),
                                                c !== n && d.push(c[h]), v[t + r[h]] = d
                                        }
                                        delete v[t]
                                    }
                                }
                            ...
                            for (var W in v) {
                                ...
                                var V = x.Hooks.getRoot(W),
                                    H = !1;
                                if (a(s).isSVG || "tween" === V || x.Names.prefixCheck(V)[1] !== !1 || x.Normalizations.registered[V] !== n) {
                                    (r.display !== n && null !== r.display && "none" !== r.display || r.visibility !== n && "hidden" !== r.visibility) && /opacity|filter/.test(W) && !z && 0 !== X && (z = 0), r._cacheValues && M && M[W] ? (z === n && (z = M[W].endValue + M[W].unitType), H = a(s).rootPropertyValueCache[V]) : x.Hooks.registered[W] ? z === n ? (H = x.getPropertyValue(s, V), z = x.getPropertyValue(s, W, H)) : H = x.Hooks.templates[V][1] : z === n && (z = x.getPropertyValue(s, W));
                                    var j, B, _, $ = !1;
                                    if (j = p(W, z), z = j[0], _ = j[1], j = p(W, X), X = j[0].replace(/^([+-\/*])=/, function(t, e) {
                                            return $ = e, ""
                                        }), B = j[1], z = parseFloat(z) || 0, X = parseFloat(X) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(W) ? (X /= 100, B = "em") : /^scale/.test(W) ? (X /= 100, B = "") : /(Red|Green|Blue)$/i.test(W) && (X = X / 100 * 255, B = "")), /[\/*]/.test($)) B = _;
                                    else if (_ !== B && 0 !== z)
                                        if (0 === X) B = _;
                                        else {
                                            o = o || m();
                                            var N = /margin|padding|left|right|width|text|word|letter/i.test(W) || /X$/.test(W) || "x" === W ? "x" : "y";
                                            switch (_) {
                                                case "%":
                                                    z *= "x" === N ? o.percentToPxWidth : o.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                            ...
                                            switch (B) {
                                                case "%":
                                                    z *= 1 / ("x" === N ? o.percentToPxWidth : o.percentToPxHeight);
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                    ...
                                    l[W] = {
                                        ...
                                        unitType: B,
                                        easing: Y
                                    }, b.debug && console.log("tweensContainer (" + W + "): " + JSON.stringify(l[W]), s)
                                } else b.debug && console.log("Skipping [" + V + "] due to a lack of browser support.")
                            }
                            l.element = s
                        }
                        l.element && (x.Values.addClass(s, "velocity-animating"), I.push(l), "" === r.queue && (a(s).tweensContainer = l, a(s).opts = r), a(s).isAnimating = !0, C === k - 1 ? (b.State.calls.push([I, f, r, null, A.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, h())) : C++)
                    }
                    var o, s = this,
                        r = d.extend({}, b.defaults, y),
                        l = {};
                    switch (a(s) === n && b.init(s), parseFloat(r.delay) && r.queue !== !1 && d.queue(s, r.queue, function(t) {
                    ...
                    b.mock !== !1 && (b.mock === !0 ? r.duration = r.delay = 1 : (r.duration *= parseFloat(b.mock) || 1, r.delay *= parseFloat(b.mock) || 1)), r.easing = c(r.easing, r.duration), r.begin && !g.isFunction(r.begin) && (r.begin = null), r.progress && !g.isFunction(r.progress) && (r.progress = null), r.complete && !g.isFunction(r.complete) && (r.complete = null), r.display !== n && null !== r.display && (r.display = r.display.toString().toLowerCase(), "auto" === r.display && (r.display = b.CSS.Values.getDisplayType(s))), r.visibility !== n && null !== r.visibility && (r.visibility = r.visibility.toString().toLowerCase()), r.mobileHA = r.mobileHA && b.State.isMobile && !b.State.isGingerbread, r.queue === !1 ? r.delay ? setTimeout(t, r.delay) : t() : d.queue(s, r.queue, function(e, i) {
                        return i === !0 ? (A.promise && A.resolver(f), !0) : (b.velocityQueueEntryFlag = !0, void t(e))
                    }), "" !== r.queue && "fx" !== r.queue || "inprogress" === d.queue(s)[0] || d.dequeue(s)
                }
                var r, l, p, f, v, y, w = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));
                if (g.isWrapped(this) ? (r = !1, p = 0, f = this, l = this) : (r = !0, p = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = s(f)) {
                    ...
                    if (!/^(stop|finish)$/i.test(v) && !d.isPlainObject(y)) {
                        var P = p + 1;
                        y = {};
                        for (var T = P; T < arguments.length; T++) g.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? g.isString(arguments[T]) || g.isArray(arguments[T]) ? y.easing = arguments[T] : g.isFunction(arguments[T]) && (y.complete = arguments[T]) : y.duration = arguments[T]
                    }
                    var A = {
                        promise: null,
                        resolver: null,
                        ...
                        case "stop":
                            ...
                            return d.each(b.State.calls, function(t, e) {
                                e && d.each(e[1], function(i, o) {
                                    var s = y === n ? "" : y;
                                    return s !== !0 && e[2].queue !== s && (y !== n || e[2].queue !== !1) || void d.each(f, function(i, n) {
                                        n === o && ((y === !0 || g.isString(y)) && (d.each(d.queue(n, g.isString(y) ? y : ""), function(t, e) {
                                            g.isFunction(e) && e(null, !0)
                                        }), d.queue(n, g.isString(y) ? y : "", [])), "stop" === v ? (a(n) && a(n).tweensContainer && s !== !1 && d.each(a(n).tweensContainer, function(t, e) {
                                            e.endValue = e.currentValue
                                        }), L.push(t)) : "finish" === v && (e[2].duration = 1))
                                    })
                                })
                            }), "stop" === v && (d.each(L, function(t, e) {
                                u(e, !0)
                            }), A.promise && A.resolver(f)), t();
                        default:
                            if (!d.isPlainObject(v) || g.isEmptyObject(v)) {
                                if (g.isString(v) && b.Redirects[v]) {
                                    var M = d.extend({}, y),
                                        R = M.duration,
                                        O = M.delay || 0;
                                    return M.backwards === !0 && (f = d.extend(!0, [], f).reverse()), d.each(f, function(t, e) {
                                        parseFloat(M.stagger) ? M.delay = O + parseFloat(M.stagger) * t : g.isFunction(M.stagger) && (M.delay = O + M.stagger.call(e, t, k)), M.drag && (M.duration = parseFloat(R) || (/^(callout|transition)/.test(v) ? 1e3 : m), M.duration = Math.max(M.duration * (M.backwards ? 1 - t / k : (t + 1) / k), .75 * M.duration, 200)), b.Redirects[v].call(e, e, M || {}, t, k, f, A.promise ? A : n)
                                    }), t()
                                }
                                var W = "Velocity: First argument (" + v + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                return A.promise ? A.rejecter(new Error(W)) : console.log(W), t()
                            }
                            E = "start"
                    }
                    var F = {
                    ...
                    if (M.loop = parseInt(M.loop), D = 2 * M.loop - 1, M.loop)
                        for (var X = 0; D > X; X++) {
                            ...
                            X === D - 1 && (Y.display = M.display, Y.visibility = M.visibility, Y.complete = M.complete), S(f, "reverse", Y)
                        }
                    return t()
                }
            };
            b = d.extend(S, b), b.animate = S;
            ...
            return b.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function() {
                ...
                }, h()) : k = e.requestAnimationFrame || f
            }), t.Velocity = b, t !== e && (t.fn.velocity = S, t.fn.velocity.defaults = b.defaults), d.each(["Down", "Up"], function(t, e) {
                b.Redirects["slide" + e] = function(t, i, o, s, a, r) {
                    var l = d.extend({}, i),
                        c = l.begin,
                        h = l.complete,
                        u = {
                ...
                b.Redirects["fade" + e] = function(t, i, o, s, a, r) {
                    var l = d.extend({}, i),
                        c = {
                            opacity: "In" === e ? 1 : 0
                        },
                        h = l.complete;
                    l.complete = o !== s - 1 ? l.begin = null : function() {
                        h && h.call(a, a), r && r.resolver(a)
    ...
    function() {
        ...
        var n = i.helpers = {},
            ...
            x = (n.calculateScaleRange = function(t, e, i, n, s) {
                ...
                var h = v(c),
                    u = g(c);
                u === h && (u += .5, h >= .5 && !n ? h -= .5 : u += .5);
                for (var d = Math.abs(u - h), p = w(d), f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p), m = n ? 0 : Math.floor(h / (1 * Math.pow(10, p))) * Math.pow(10, p), y = f - m, b = Math.pow(10, p), x = Math.round(y / b);
                    (x > r || 2 * x < r) && !l;)
            ...
            C = (n.cancelAnimFrame = function() {
                ...
                var a = 0,
                    ...
                    l = function() {
                        ...
                        var i = a / e,
                            c = r(i);
                        t.call(s, c, i, a), n.call(s, c, i), a < e ? s.animationFrame = k(l) : o.apply(s)
                    };
                k(l)
            ...
            F = n.drawRoundedRectangle = function(t, e, i, n, o, s) {
        ...
        i.instances = {}, i.Type = function(t, e, n) {
            ...
            resize: function(t) {
                ...
                return e.width = this.chart.width = i, e.height = this.chart.height = n, M(this.chart), "function" == typeof t && t.apply(this, Array.prototype.slice.call(arguments, 1)), this
            },
            reflow: h,
            render: function(t) {
                            ...
                            var h = [],
                                ...
                                d = function(t) {
                                    ...
                                    return n.each(this.datasets, function(t) {
                                        ...
                                        c.push(t.x), d.push(t.y), h.push(n.template(this.options.multiTooltipTemplate, t)), u.push({
                                            fill: t._saved.fillColor || t.fillColor,
                                            stroke: t._saved.strokeColor || t.strokeColor
                                        })
                                    }, this), a = v(d), o = g(d), s = v(c), i = g(c), {
            ...
            inRange: function(t, e) {
                var i = n.getAngleFromPoint(this, {
                    ...
                    o = i.angle % (2 * Math.PI),
                    s = (2 * Math.PI + this.startAngle) % (2 * Math.PI),
                    a = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360,
                    r = a < s ? o <= a || o >= s : o >= s && o <= a,
            ...
            draw: function() {
                ...
                if (t.fillStyle = this.fillColor, this.custom) this.custom(this);
                    ...
                    F(t, s, a, i, n, this.cornerRadius), t.fill(), t.fillStyle = this.textColor, t.textAlign = "center", t.textBaseline = "middle", t.fillText(this.text, s + i / 2, a + n / 2)
                }
            }
            ...
            buildYLabels: function() {
                this.yLabels = [];
                for (var t = m(this.stepValue), e = 0; e <= this.steps; e++) this.yLabels.push(x(this.templateString, {
            ...
            draw: function() {
                ...
                this.display && (t.fillStyle = this.textColor, t.font = this.font, o(this.yLabels, function(o, s) {
                    ...
                    0 !== i || a || (a = !0), a && t.beginPath(), i > 0 ? (t.lineWidth = this.gridLineWidth, t.strokeStyle = this.gridLineColor) : (t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor), a && (t.moveTo(o, this.endPoint), t.lineTo(o, this.startPoint - 3),
            ...
            setScaleSize: function() {
                var t, e, i, n, o, s, a, r, l, c, h, u, d = v([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
                    p = this.width,
                    g = 0;
                for (this.ctx.font = O(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), e = 0; e < this.valuesCount; e++) t = this.getPointPosition(e, d), i = this.ctx.measureText(x(this.templateString, {
                    value: this.labels[e]
                ...
                l = g, c = Math.ceil(p - this.width), s = this.getIndexAngle(o), r = this.getIndexAngle(a), h = c / Math.sin(s + Math.PI / 2), u = l / Math.sin(r + Math.PI / 2), h = f(h) ? h : 0, u = f(u) ? u : 0, this.drawingArea = d - (u + h) / 2, this.setCenterPoint(u, h)
            },
                    ...
                    if (o(this.yLabels, function(e, i) {
                        ...
                        for (var e = this.valuesCount - 1; e >= 0; e--) {
                            ...
                            if (this.angleLineWidth > 0 && (i = this.calculateCenterOffset(this.max), n = this.getPointPosition(e, i), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(n.x, n.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                                ...
                                var s = this.getPointPosition(0 === e ? this.valuesCount - 1 : e - 1, i),
                                    a = this.getPointPosition(e === this.valuesCount - 1 ? 0 : e + 1, i),
                                    r = {
                                        x: (s.x + n.x) / 2,
                                        y: (s.y + n.y) / 2
                                    },
                            ...
                            var h = this.labels.length,
                                u = this.labels.length / 2,
                                d = u / 2,
                                p = e < d || e > h - d,
                                f = e === d || e === h - d;
                            0 === e ? t.textAlign = "center" : e === u ? t.textAlign = "center" : e < u ? t.textAlign = "left" : t.textAlign = "right", f ? t.textBaseline = "middle" : p ? t.textBaseline = "bottom" : t.textBaseline = "top", t.fillText(this.labels[e], c.x, c.y)
                        }
                    }
                }
            }
            ...
            startDigest: function() {
                ...
                var o = Date.now(),
                    s = o - t - this.frameDuration,
                    a = s / this.frameDuration;
    ...
    function(t, e) {
        ...
        function o(t) {
            var e = d.call(t);
            return "[object String]" === e ? u(t) : i(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(e) && t.hasOwnProperty("length") ? t : n(t) ? [t] : []
        }
        ...
        function s(t) {
            var i, n, o = {
                ...
                s = t && t.ownerDocument;
            return i = s.documentElement, "undefined" != typeof t.getBoundingClientRect && (o = t.getBoundingClientRect()), n = e(s), {
            ...
            if (i) {
                ...
                setTimeout(function() {
                    var t = {
                        ...
                        "-moz-transition-duration": h + "ms",
                        "-o-transition-duration": h + "ms",
        ...
        function l(t) {
            if (v.allowEvent(t) === !1) return null;
        ...
        function c(t) {
            ...
            if (null !== e) {
                ...
                if (v.registerEvent(t), "touchstart" === t.type && f.delay) {
                    var i = !1,
                        n = setTimeout(function() {
                            n = null, f.show(t, e)
                        }, f.delay),
                        o = function(o) {
                            n && (clearTimeout(n), n = null, f.show(t, e)), i || (i = !0, f.hide(o, e))
                        },
                        s = function(t) {
        ...
        var h = h || {},
            ...
            f = {
                ...
                show: function(t, e, i) {
                    ...
                    var o = s(e),
                        r = 0,
                        l = 0;
                    "touches" in t && t.touches.length ? (r = t.touches[0].pageY - o.top, l = t.touches[0].pageX - o.left) : (r = t.pageY - o.top, l = t.pageX - o.left), l = l >= 0 ? l : 0, r = r >= 0 ? r : 0;
                    var c = "scale(" + e.clientWidth / 100 * 3 + ")",
                        h = "translate(0,0)";
                    i && (h = "translate(" + i.x + "px, " + i.y + "px)"), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-x", l), n.setAttribute("data-y", r), n.setAttribute("data-scale", c), n.setAttribute("data-translate", h);
                    var u = {
                        top: r + "px",
                        left: l + "px"
                    };
                    n.classList.add("waves-notransition"), n.setAttribute("style", a(u)), n.classList.remove("waves-notransition"), u["-webkit-transform"] = c + " " + h, u["-moz-transform"] = c + " " + h, u["-ms-transform"] = c + " " + h, u["-o-transform"] = c + " " + h, u.transform = c + " " + h, u.opacity = "1";
                    var d = "mousemove" === t.type ? 2500 : f.duration;
                    u["-webkit-transition-duration"] = d + "ms", u["-moz-transition-duration"] = d + "ms", u["-o-transition-duration"] = d + "ms", u["transition-duration"] = d + "ms", n.setAttribute("style", a(u))
                },
                hide: function(t, e) {
                    e = e || this;
                    for (var i = e.getElementsByClassName("waves-rippling"), n = 0, o = i.length; n < o; n++) r(t, e, i[n])
                }
            },
            g = {
                input: function(t) {
                    ...
                    if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
                        ...
                        var n = window.getComputedStyle(t, null),
                            o = n.color,
                            s = n.backgroundColor;
                        i.setAttribute("style", "color:" + o + ";background:" + s), t.setAttribute("style", "background-color:rgba(0,0,0,0);")
                    }
                },
                img: function(t) {
                    var e = t.parentNode;
            ...
            v = {
                ...
                allowEvent: function(t) {
                    var e = !0;
                    return /^(mousedown|mousemove)$/.test(t.type) && v.touches && (e = !1), e
                },
                registerEvent: function(t) {
                    var e = t.type;
                    "touchstart" === e ? v.touches += 1 : /^(touchend|touchcancel)$/.test(e) && setTimeout(function() {
        ...
        return h.init = function(t) {
            var e = document.body;
            t = t || {}, "duration" in t && (f.duration = t.duration), "delay" in t && (f.delay = t.delay), p && (e.addEventListener("touchstart", c, !1), e.addEventListener("touchcancel", v.registerEvent, !1), e.addEventListener("touchend", v.registerEvent, !1)), e.addEventListener("mousedown", c, !1)
        }, h.attach = function(t, e) {
            t = o(t), "[object Array]" === d.call(e) && (e = e.join(" ")), e = e ? " " + e : "";
            for (var i, n, s = 0, a = t.length; s < a; s++) i = t[s], n = i.tagName.toLowerCase(), ["input", "img"].indexOf(n) !== -1 && (g[n](i), i = i.parentElement), i.className.indexOf("waves-effect") === -1 && (i.className += " waves-effect" + e)
        }, h.ripple = function(t, e) {
            t = o(t);
            var i = t.length;
            if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, i)
                for (var n, a, r, l = {}, c = 0, h = {
                        type: "mousedown",
                        button: 1
                    }, u = function(t, e) {
                        return function() {
                    ...
                    if (n = t[c], a = e.position || {
                            x: n.clientWidth / 2,
                            y: n.clientHeight / 2
                        }, r = s(n), l.x = r.left + a.x, l.y = r.top + a.y, h.pageX = l.x, h.pageY = l.y, f.show(h, n), e.wait >= 0 && null !== e.wait) {
                        var d = {
                            type: "mouseup",
                            button: 1
                        };
                        setTimeout(u(d, n), e.wait)
                    }
        }, h.calm = function(t) {
            t = o(t);
            for (var e = {
                    type: "mouseup",
                    button: 1
                }, i = 0, n = t.length; i < n; i++) f.hide(e, t[i])
        }, h.displayEffect = function(t) {
            console.error("Waves.displayEffect() has been deprecated and will be removed in future version. Please use Waves.init() to initialize Waves effect"), h.init(t)
        }, h
            ...
            this.each(function() {
                ...
                function o(e) {
                    ...
                    var i = window.innerHeight,
                        o = a.innerHeight(),
                        s = a.offset().left,
                        h = a.offset().top - t(window).scrollTop(),
                        u = r.alignment,
                        d = 0,
                        p = 0,
                        f = 0;
                    ...
                    var g = 0,
                        v = a.parent();
                    if (!v.is("body") && v[0].scrollHeight > v[0].clientHeight && (g = v[0].scrollTop), s + c.innerWidth() > t(window).width() ? u = "right" : s - c.innerWidth() + a.innerWidth() < 0 && (u = "left"), h + c.innerHeight() > i)
                        if (h + o - c.innerHeight() < 0) {
                            var m = i - h - f;
                            c.css("max-height", m)
                        } else f || (f += o), f -= c.innerHeight();
                    if ("left" === u) d = r.gutter, p = a.position().left + d;
                    else if ("right" === u) {
                ...
                if (n(), a.after(c), r.hover) {
                    ...
                    a.unbind("click." + a.attr("id")), a.on("mouseenter", function(t) {
                        ...
                        t(i).closest(".dropdown-content").is(c) || (c.stop(!0, !0), s(), h = !1)
                    }), c.on("mouseleave", function(e) {
                        var i = e.toElement || e.relatedTarget;
                        t(i).closest(".dropdown-button").is(a) || (c.stop(!0, !0), s(), h = !1)
                    })
                } else a.unbind("click." + a.attr("id")), a.bind("click." + a.attr("id"), function(e) {
                    l || (a[0] != e.currentTarget || a.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? a.hasClass("active") && (s(), t(document).unbind("click." + c.attr("id") + " touchstart." + c.attr("id"))) : (e.preventDefault(), o("click")), c.hasClass("active") && t(document).bind("click." + c.attr("id") + " touchstart." + c.attr("id"), function(e) {
                        c.is(e.target) || a.is(e.target) || a.find(e.target).length || (s(), t(document).unbind("click." + c.attr("id") + " touchstart." + c.attr("id")))
                    }))
                });
...
dropdownSelectors.on({
    ...
    function(t) {
        t.fn.collapsible = function(e) {
            ...
            return e = t.extend(i, e), this.each(function() {
                ...
                a.off("click.collapse", ".collapsible-header"), r.off("click.collapse"), e.accordion || "accordion" === l || void 0 === l ? (r = a.find("> li > .collapsible-header"), r.on("click.collapse", function(e) {
                    var n = t(e.target);
                    o(n) && (n = s(n)), n.toggleClass("active"), i(n)
                }), i(r.filter(".active").first())) : r.each(function() {
                    t(this).on("click.collapse", function(e) {
                        var i = t(e.target);
                        o(i) && (i = s(i)), i.toggleClass("active"), n(i)
    ...
    function(t) {
        ...
        var i = function(e) {
                if ($this = e, $this.hasClass("active") === !1) {
                    var i, n, o = $this.hasClass("horizontal");
                    o === !0 ? n = 40 : i = 40, $this.addClass("active"), $this.find("ul .btn-floating").velocity({
                        scaleY: ".4",
                        scaleX: ".4",
                        translateY: i + "px",
                        translateX: n + "px"
    ...
    function(t, e, i, n) {
        ...
        function w(t, e) {
            for (var i, o, s = e[0].toUpperCase() + e.slice(1), a = 0; a < dt.length;) {
                if (i = dt[a], o = i ? i + s : e, o in t) return o;
                a++
            }
            return n
        }
        ...
        function C(t) {
            ...
            return new(e = i ? i : kt ? Y : Ct ? H : St ? B : X)(t, P)
        }
        ...
        function P(t, e, i) {
            var n = i.pointers.length,
                ...
                s = e & Mt && n - o === 0,
                a = e & (Ot | Wt) && n - o === 0;
            i.isFirst = !!s, i.isFinal = !!a, s && (t.session = {}), i.eventType = e, T(t, i), t.emit("hammer.input", i), t.recognize(i), t.session.prevInput = i
        }
        ...
        function T(t, e) {
            ...
            var s = i.firstInput,
                ...
                l = e.center = M(n);
            e.timeStamp = mt(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = F(r, l), e.distance = W(r, l), A(i, e), e.offsetDirection = O(e.deltaX, e.deltaY);
            var c = R(e.deltaTime, e.deltaX, e.deltaY);
            e.overallVelocityX = c.x, e.overallVelocityY = c.y, e.overallVelocity = vt(c.x) > vt(c.y) ? c.x : c.y, e.scale = a ? D(a.pointers, n) : 1, e.rotation = a ? I(a.pointers, n) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length, E(i, e);
            var h = t.element;
        ...
        function A(t, e) {
            var i = e.center,
                ...
                o = t.prevDelta || {},
                s = t.prevInput || {};
            e.eventType !== Mt && s.eventType !== Ot || (o = t.prevDelta = {
                x: s.deltaX || 0,
                y: s.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function E(t, e) {
            var i, o, s, a, r = t.lastInterval || e,
                l = e.timeStamp - r.timeStamp;
            if (e.eventType != Wt && (l > Lt || r.velocity === n)) {
                var c = e.deltaX - r.deltaX,
                    h = e.deltaY - r.deltaY,
                    u = R(l, c, h);
                o = u.x, s = u.y, i = vt(u.x) > vt(u.y) ? u.x : u.y, a = O(c, h), t.lastInterval = e
        ...
        function O(t, e) {
            return t === e ? Ft : vt(t) >= vt(e) ? t < 0 ? It : Dt : e < 0 ? Xt : Yt
        }
        ...
        function X() {
            this.evEl = $t, this.evWin = Nt, this.pressed = !1, k.apply(this, arguments)
        }

        function Y() {
            this.evEl = Gt, this.evWin = Ut, k.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function z() {
            this.evTarget = Jt, this.evWin = Kt, this.started = !1, k.apply(this, arguments)
        }

        function V(t, e) {
            var i = y(t.touches),
                n = y(t.changedTouches);
            return e & (Ot | Wt) && (i = b(i.concat(n), "identifier", !0)), [i, n]
        }
        ...
        function j(t, e) {
            var i = y(t.touches),
                n = this.targetIds;
            if (e & (Mt | Rt) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
            var o, s, a = y(t.changedTouches),
                r = [],
                l = this.target;
            ...
            for (o = 0; o < a.length;) n[a[o].identifier] && r.push(a[o]), e & (Ot | Wt) && delete n[a[o].identifier], o++;
            return r.length ? [b(s.concat(r), "identifier", !0), r] : void 0
        }

        function B() {
            k.apply(this, arguments);
            var t = c(this.handler, this);
            this.touch = new H(this.manager, t), this.mouse = new X(this.manager, t), this.primaryTouch = null, this.lastTouches = []
        }

        function _(t, e) {
            t & Mt ? (this.primaryTouch = e.changedPointers[0].identifier, $.call(this, e)) : t & (Ot | Wt) && $.call(this, e)
        }
        ...
        function Q(t) {
            ...
            var e = g(t, he),
                i = g(t, ue);
            return e && i ? ce : e || i ? e ? he : ue : g(t, le) ? le : re
        }
        ...
        function U(t) {
            this.options = ut({}, this.defaults, t || {}), this.id = x(), this.manager = null, this.options.enable = u(this.options.enable, !0), this.state = pe, this.simultaneous = {}, this.requireFail = []
        }

        function Z(t) {
            return t & ye ? "cancel" : t & ve ? "end" : t & ge ? "move" : t & fe ? "start" : ""
        }

        function J(t) {
            return t == Yt ? "down" : t == Xt ? "up" : t == It ? "left" : t == Dt ? "right" : ""
        }
        ...
        function rt(t, e) {
            return e = e || {}, e.recognizers = u(e.recognizers, rt.defaults.preset), new lt(t, e)
        }

        function lt(t, e) {
            this.options = ut({}, rt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = C(this), this.touchAction = new q(this, this.options.touchAction), ct(this, !0), a(this.options.recognizers, function(t) {
        ...
        function ct(t, e) {
            ...
            if (i.style) {
                var n;
                a(t.options.cssProps, function(o, s) {
        ...
        var yt = r(function(t, e, i) {
            ...
            Ct = St && xt.test(navigator.userAgent),
            Pt = "touch",
            Tt = "pen",
            At = "mouse",
            Et = "kinect",
        ...
        k.prototype = {
            handler: function() {},
            init: function() {
                this.evEl && d(this.element, this.evEl, this.domHandler), this.evTarget && d(this.target, this.evTarget, this.domHandler), this.evWin && d(S(this.element), this.evWin, this.domHandler)
            },
            destroy: function() {
        ...
        l(X, k, {
            handler: function(t) {
                var e = _t[t.type];
                e & Mt && 0 === t.button && (this.pressed = !0), e & Rt && 1 !== t.which && (e = Ot), this.pressed && (e & Ot && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: At,
                    srcEvent: t
        ...
        t.MSPointerEvent && !t.PointerEvent && (Gt = "MSPointerDown", Ut = "MSPointerMove MSPointerUp MSPointerCancel"), l(Y, k, {
            handler: function(t) {
                var e = this.store,
                    i = !1,
                    ...
                    a = s == Pt,
                    r = m(e, t.pointerId, "pointerId");
                o & Mt && (0 === t.button || a) ? r < 0 && (e.push(t), r = e.length - 1) : o & (Ot | Wt) && (i = !0), r < 0 || (e[r] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: s,
                    srcEvent: t
        ...
        l(z, k, {
            handler: function(t) {
                ...
                if (e === Mt && (this.started = !0), this.started) {
                    var i = V.call(this, t, e);
                    e & (Ot | Wt) && i[0].length - i[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: Pt,
                        srcEvent: t
        ...
        l(B, k, {
            handler: function(t, e, i) {
                ...
                if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                    if (n) _.call(this, e, i);
                    else if (o && N.call(this, i)) return;
                    this.callback(t, e, i)
                }
            },
            destroy: function() {
        ...
        q.prototype = {
            set: function(t) {
                t == ae && (t = this.compute()), se && this.manager.element.style && de[t] && (this.manager.element.style[oe] = t), this.actions = t.toLowerCase().trim()
            },
            update: function() {
            ...
            preventDefaults: function(t) {
                ...
                return a && s ? void 0 : o || s && i & zt || a && i & Vt ? this.preventSrc(e) : void 0
            },
        ...
        U.prototype = {
            ...
            requireFailure: function(t) {
                ...
                return t = K(t, this), m(e, t) === -1 && (e.push(t), t.requireFailure(this)), this
            },
            ...
            emit: function(t) {
                ...
                var i = this,
                    n = this.state;
                n < ve && e(i.options.event + Z(n)), e(i.options.event), t.additionalEvent && e(t.additionalEvent), n >= ve && e(i.options.event + Z(n))
            },
            tryEmit: function(t) {
            ...
            recognize: function(t) {
                var e = ut({}, t);
                return h(this.options.enable, [this, e]) ? (this.state & (me | ye | be) && (this.state = pe), this.state = this.process(e), void(this.state & (fe | ge | ve | ye) && this.tryEmit(e))) : (this.reset(), void(this.state = be))
            },
            process: function(t) {},
            ...
            process: function(t) {
                var e = this.state,
                    ...
                    n = e & (fe | ge),
                    o = this.attrTest(t);
                return n && (i & Wt || !o) ? e | ye : n || o ? i & Ot ? e | ve : e & fe ? e | ge : fe : be
            }
        }), l(et, tt, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function() {
                var t = this.options.direction,
                    e = [];
                return t & zt && e.push(ue), t & Vt && e.push(he), e
            },
            directionTest: function(t) {
                var e = this.options,
                    ...
                    s = t.deltaX,
                    a = t.deltaY;
                return o & e.direction || (e.direction & zt ? (o = 0 === s ? Ft : s < 0 ? It : Dt, i = s != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === a ? Ft : a < 0 ? Xt : Yt, i = a != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
            },
            attrTest: function(t) {
            ...
            process: function(t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Ot | Wt) && !s) this.reset();
                else if (t.eventType & Mt) this.reset(), this._timer = o(function() {
                    this.state = me, this.tryEmit()
                }, e.time, this);
                else if (t.eventType & Ot) return me;
                return be
            },
            reset: function() {
            ...
            emit: function(t) {
                this.state === me && (t && t.eventType & Ot ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = mt(), this.manager.emit(this.options.event, this._input)))
            }
        }), l(ot, tt, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function(t) {
                ...
                return i & (zt | Vt) ? e = t.overallVelocity : i & zt ? e = t.overallVelocityX : i & Vt && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && vt(e) > this.options.velocity && t.eventType & Ot
            },
            emit: function(t) {
            ...
            process: function(t) {
                ...
                if (n && s && i) {
                    ...
                    var a = !this.pTime || t.timeStamp - this.pTime < e.interval,
                        r = !this.pCenter || W(this.pCenter, t.center) < e.posThreshold;
        ...
        lt.prototype = {
            set: function(t) {
                return ut(this.options, t),
                    t.touchAction && this.touchAction.update(), t.inputTarget && (this.input.destroy(), this.input.target = t.inputTarget, this.input.init()), this
            },
            stop: function(t) {
            ...
            recognize: function(t) {
                ...
                if (!e.stopped) {
                    ...
                    var i, n = this.recognizers,
                        o = e.curRecognizer;
                    (!o || o && o.state & me) && (o = e.curRecognizer = null);
                    for (var s = 0; s < n.length;) i = n[s], e.stopped === xe || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (fe | ge | ve) && (o = e.curRecognizer = i), s++
                }
            },
            get: function(t) {
        ...
        var Se = "undefined" != typeof t ? t : "undefined" != typeof self ? self : {};
        Se.Hammer = rt, "function" == typeof define && define.amd ? define(function() {
            return rt
    ...
    function(t) {
        var e = {
            init: function(e) {
                ...
                e = t.extend(i, e), t(this).each(function() {
                    ...
                    var s = t('<div class="drag-target"></div>');
                    t("body").append(s), "left" == e.edge ? (o.css("transform", "translateX(-100%)"), s.css({
                        left: 0
                    })) : (o.addClass("right-aligned").css("transform", "translateX(100%)"), s.css({
                        right: 0
                    ...
                    s.on("click", function() {
                        ...
                        if ("touch" == n.gesture.pointerType) {
                            var s = (n.gesture.direction, n.gesture.center.x),
                            ...
                            if ("left" === e.edge && (s > e.menuWidth ? s = e.menuWidth : s < 0 && (s = 0)), "left" === e.edge) s < e.menuWidth / 2 ? r = !1 : s >= e.menuWidth / 2 && (r = !0), o.css("transform", "translateX(" + (s - e.menuWidth) + "px)");
                            else {
                                s < window.innerWidth - e.menuWidth / 2 ? r = !0 : s >= window.innerWidth - e.menuWidth / 2 && (r = !1);
                                var h = s - e.menuWidth / 2;
                                h < 0 && (h = 0), o.css("transform", "translateX(" + h + "px)")
                            }
                            var u;
                            "left" === e.edge ? (u = s / e.menuWidth, t("#sidenav-overlay").velocity({
                                opacity: u
                            }, {
                                duration: 10,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (u = Math.abs((s - window.innerWidth) / e.menuWidth), t("#sidenav-overlay").velocity({
                                opacity: u
                            }, {
                                duration: 10,
                                queue: !1,
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            var n = i.gesture.velocityX,
                                ...
                                c = l - e.menuWidth,
                                h = l - e.menuWidth / 2;
                            c > 0 && (c = 0), h < 0 && (h = 0), a = !1, "left" === e.edge ? r && n <= .3 || n < -.5 ? (0 != c && o.velocity({
                                translateX: [0, c]
                            }, {
                                duration: 300,
                                queue: !1,
                        ...
                        if (r === !0) r = !1, a = !1, i();
                            ...
                            var n = t("body"),
                                l = n.innerWidth();
                            n.css("overflow", "hidden"), n.width(l), t("body").append(s), "left" === e.edge ? (s.css({
                                width: "50%",
                                right: 0,
                                left: ""
                            }), o.velocity({
        ...
        3: [function(t, e, i) {
            ...
            a.e = function(t, e) {
                ...
                return "object" == typeof e ? s(t, e) : "undefined" == typeof i ? n(t, e) : o(t, e, i)
        ...
        10: [function(t, e, i) {
            ...
            function n(t, e) {
                ...
                e.settings.stopPropagationOnClick && e.event.bind(e.scrollbarY, "click", n), e.event.bind(e.scrollbarYRail, "click", function(n) {
                    var s = o.toInt(e.scrollbarYHeight / 2),
                        l = e.railYRatio * (n.pageY - window.pageYOffset - i(e.scrollbarYRail).top - s),
                        c = e.railYRatio * (e.railYHeight - e.scrollbarYHeight),
                        h = l / c;
                    h < 0 ? h = 0 : h > 1 && (h = 1), r(t, "top", (e.contentHeight - e.containerHeight) * h), a(t), n.stopPropagation()
                }), e.settings.stopPropagationOnClick && e.event.bind(e.scrollbarX, "click", n), e.event.bind(e.scrollbarXRail, "click", function(n) {
                    var s = o.toInt(e.scrollbarXWidth / 2),
                        l = e.railXRatio * (n.pageX - window.pageXOffset - i(e.scrollbarXRail).left - s),
                        c = e.railXRatio * (e.railXWidth - e.scrollbarXWidth),
                        h = l / c;
                    h < 0 ? h = 0 : h > 1 && (h = 1), r(t, "left", (e.contentWidth - e.containerWidth) * h - e.negativeScrollAdjustment), a(t), n.stopPropagation()
                })
            }
            var o = t("../../lib/helper"),
                s = t("../instances"),
        ...
        11: [function(t, e, i) {
            ...
            function n(t, e) {
                ...
                var n = null,
                    ...
                    h = function() {
                        s.stopScrolling(t, "x"), e.event.unbind(e.ownerDocument, "mousemove", r)
                    };
                e.event.bind(e.scrollbarX, "mousedown", function(i) {
                    o = i.pageX, n = s.toInt(a.css(e.scrollbarX, "left")) * e.railXRatio, s.startScrolling(t, "x"), e.event.bind(e.ownerDocument, "mousemove", r), e.event.once(e.ownerDocument, "mouseup", h), i.stopPropagation(), i.preventDefault()
                })
            }
            ...
            function o(t, e) {
                ...
                var n = null,
                    ...
                    h = function() {
                        s.stopScrolling(t, "y"), e.event.unbind(e.ownerDocument, "mousemove", r)
                    };
                e.event.bind(e.scrollbarY, "mousedown", function(i) {
                    o = i.pageY, n = s.toInt(a.css(e.scrollbarY, "top")) * e.railYRatio, s.startScrolling(t, "y"), e.event.bind(e.ownerDocument, "mousemove", r), e.event.once(e.ownerDocument, "mouseup", h), i.stopPropagation(), i.preventDefault()
                })
            }
            var s = t("../../lib/helper"),
                a = t("../../lib/dom"),
            ...
            function n(t, e) {
                ...
                e.event.bind(e.ownerDocument, "keydown", function(c) {
                    if (!(c.isDefaultPrevented && c.isDefaultPrevented() || c.defaultPrevented)) {
                        var h = s.matches(e.scrollbarX, ":focus") || s.matches(e.scrollbarY, ":focus");
                        if (n || h) {
                            ...
                            l(t, "top", t.scrollTop - p), l(t, "left", t.scrollLeft + d), r(t), a = i(d, p), a && c.preventDefault()
                        }
                    }
                })
            }
            ...
            function n(t, e) {
                ...
                function r(r) {
                    var c = n(r),
                        h = c[0],
                        u = c[1];
                    o(h, u) || (l = !1, e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (u ? a(t, "top", t.scrollTop - u * e.settings.wheelSpeed) : a(t, "top", t.scrollTop + h * e.settings.wheelSpeed), l = !0) : e.scrollbarXActive && !e.scrollbarYActive && (h ? a(t, "left", t.scrollLeft + h * e.settings.wheelSpeed) : a(t, "left", t.scrollLeft - u * e.settings.wheelSpeed), l = !0) : (a(t, "top", t.scrollTop - u * e.settings.wheelSpeed), a(t, "left", t.scrollLeft + h * e.settings.wheelSpeed)), s(t), l = l || i(h, u), l && (r.stopPropagation(), r.preventDefault()))
                }
                var l = !1;
                "undefined" != typeof window.onwheel ? e.event.bind(t, "wheel", r) : "undefined" != typeof window.onmousewheel && e.event.bind(t, "mousewheel", r)
            }
            var o = t("../instances"),
                s = t("../update-geometry"),
                a = t("../update-scroll");
            ...
            function n(t, e) {
                ...
                function n() {
                    c || (c = setInterval(function() {
                        return s.get(t) ? (r(t, "top", t.scrollTop + h.top), r(t, "left", t.scrollLeft + h.left), void a(t)) : void clearInterval(c)
                    }, 50))
                }
                ...
                e.event.bind(e.ownerDocument, "selectionchange", function() {
                    ...
                    if (u) {
                        ...
                        i.x < s.left + 3 ? (h.left = -5, o.startScrolling(t, "x")) : i.x > s.right - 3 ? (h.left = 5, o.startScrolling(t, "x")) : h.left = 0, i.y < s.top + 3 ? (s.top + 3 - i.y < 5 ? h.top = -5 : h.top = -20, o.startScrolling(t, "y")) : i.y > s.bottom - 3 ? (i.y - s.bottom + 3 < 5 ? h.top = 5 : h.top = 20, o.startScrolling(t, "y")) : h.top = 0, 0 === h.top && 0 === h.left ? l() : n()
                    }
                })
            }
            var o = t("../../lib/helper"),
        ...
        16: [function(t, e, i) {
            ...
            function n(t, e, i, n) {
                function o(i, n) {
                    ...
                    } else if (a > r && (i < 0 && s === e.contentWidth - e.containerWidth || i > 0 && 0 === s)) return !e.settings.swipePropagation;
                    return !0
                }
                ...
                function f(t) {
                    if (!x && e.settings.swipePropagation && p(t), !w && x && d(t)) {
                        ...
                        var r = (new Date).getTime(),
                            c = r - m;
                        c > 0 && (y.x = s / c, y.y = a / c, m = r), o(s, a) && (t.stopPropagation(), t.preventDefault())
                    }
                }

                function g() {
                    !w && x && (x = !1, clearInterval(b), b = setInterval(function() {
                        return s.get(t) ? Math.abs(y.x) < .01 && Math.abs(y.y) < .01 ? void clearInterval(b) : (l(30 * y.x, 30 * y.y), y.x *= .8, void(y.y *= .8)) : void clearInterval(b)
                    }, 10))
                }
                var v = {},
                    m = 0,
        ...
        18: [function(t, e, i) {
            ...
            function n(t) {
                ...
                var n = this;
                n.settings = r.clone(c), n.containerWidth = null, n.containerHeight = null, n.contentWidth = null, n.contentHeight = null, n.isRtl = "rtl" === h.css(t, "direction"), n.isNegativeScroll = function() {
                    var e = t.scrollLeft,
                        i = null;
                    return t.scrollLeft = -1, i = t.scrollLeft < 0, t.scrollLeft = e, i
                }(), n.negativeScrollAdjustment = n.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0, n.event = new u, n.ownerDocument = t.ownerDocument || document, n.scrollbarXRail = h.appendTo(h.e("div", "ps-scrollbar-x-rail"), t), n.scrollbarX = h.appendTo(h.e("div", "ps-scrollbar-x"), n.scrollbarXRail), n.scrollbarX.setAttribute("tabindex", 0), n.event.bind(n.scrollbarX, "focus", e), n.event.bind(n.scrollbarX, "blur", i), n.scrollbarXActive = null, n.scrollbarXWidth = null, n.scrollbarXLeft = null, n.scrollbarXBottom = r.toInt(h.css(n.scrollbarXRail, "bottom")), n.isScrollbarXUsingBottom = n.scrollbarXBottom === n.scrollbarXBottom, n.scrollbarXTop = n.isScrollbarXUsingBottom ? null : r.toInt(h.css(n.scrollbarXRail, "top")), n.railBorderXWidth = r.toInt(h.css(n.scrollbarXRail, "borderLeftWidth")) + r.toInt(h.css(n.scrollbarXRail, "borderRightWidth")), h.css(n.scrollbarXRail, "display", "block"), n.railXMarginWidth = r.toInt(h.css(n.scrollbarXRail, "marginLeft")) + r.toInt(h.css(n.scrollbarXRail, "marginRight")), h.css(n.scrollbarXRail, "display", ""), n.railXWidth = null, n.railXRatio = null, n.scrollbarYRail = h.appendTo(h.e("div", "ps-scrollbar-y-rail"), t), n.scrollbarY = h.appendTo(h.e("div", "ps-scrollbar-y"), n.scrollbarYRail), n.scrollbarY.setAttribute("tabindex", 0), n.event.bind(n.scrollbarY, "focus", e), n.event.bind(n.scrollbarY, "blur", i), n.scrollbarYActive = null, n.scrollbarYHeight = null, n.scrollbarYTop = null, n.scrollbarYRight = r.toInt(h.css(n.scrollbarYRail, "right")), n.isScrollbarYUsingRight = n.scrollbarYRight === n.scrollbarYRight, n.scrollbarYLeft = n.isScrollbarYUsingRight ? null : r.toInt(h.css(n.scrollbarYRail, "left")), n.scrollbarYOuterWidth = n.isRtl ? r.outerWidth(n.scrollbarY) : null, n.railBorderYWidth = r.toInt(h.css(n.scrollbarYRail, "borderTopWidth")) + r.toInt(h.css(n.scrollbarYRail, "borderBottomWidth")), h.css(n.scrollbarYRail, "display", "block"), n.railYMarginHeight = r.toInt(h.css(n.scrollbarYRail, "marginTop")) + r.toInt(h.css(n.scrollbarYRail, "marginBottom")), h.css(n.scrollbarYRail, "display", ""), n.railYHeight = null, n.railYRatio = null
            }
        ...
        20: [function(t, e, i) {
            ...
            a.initEvent("ps-scroll-up", !0, !0), r.initEvent("ps-scroll-down", !0, !0), l.initEvent("ps-scroll-left", !0, !0), c.initEvent("ps-scroll-right", !0, !0), h.initEvent("ps-scroll-y", !0, !0), u.initEvent("ps-scroll-x", !0, !0), d.initEvent("ps-x-reach-start", !0, !0), p.initEvent("ps-x-reach-end", !0, !0), f.initEvent("ps-y-reach-start", !0, !0), g.initEvent("ps-y-reach-end", !0, !0), e.exports = function(t, e, i) {
                ...
                "top" === e && i <= 0 && (t.scrollTop = i = 0, t.dispatchEvent(f)), "left" === e && i <= 0 && (t.scrollLeft = i = 0, t.dispatchEvent(d));
                var v = s.get(t);
                "top" === e && i >= v.contentHeight - v.containerHeight && (i = v.contentHeight - v.containerHeight, i - t.scrollTop <= 1 ? i = t.scrollTop : t.scrollTop = i, t.dispatchEvent(g)), "left" === e && i >= v.contentWidth - v.containerWidth && (i = v.contentWidth - v.containerWidth, i - t.scrollLeft <= 1 ? i = t.scrollLeft : t.scrollLeft = i,
                    t.dispatchEvent(p)), n || (n = t.scrollTop), o || (o = t.scrollLeft), "top" === e && i < n && t.dispatchEvent(a), "top" === e && i > n && t.dispatchEvent(r), "left" === e && i < o && t.dispatchEvent(l), "left" === e && i > o && t.dispatchEvent(c), "top" === e && (t.scrollTop = n = i, t.dispatchEvent(h)), "left" === e && (t.scrollLeft = o = i, t.dispatchEvent(u))
            }
        }, {
            "./instances": 18
        }],
    ...
    function(t, e) {
        ...
        var e = function(t, e) {
                ...
                this.getCanvas = function() {
                    ...
                    e.scaleColor || e.trackColor ? o.getImageData && o.putImageData ? i ? o.putImageData(i, 0, 0) : (h(), i = o.getImageData(0, 0, e.size * s, e.size * s)) : (this.clear(), h()) : this.clear(), o.lineCap = e.lineCap;
                    var n;
    ...
    function(t) {
        t(document).ready(function() {
            function e(e) {
                ...
                n.html(s), e.is(":visible") ? n.css("width", e.width()) : n.css("width", t(window).width() / 2), e.css("height", n.height())
            }
            ...
            t(document).on("change", i, function() {
                ...
                var e = void 0 !== t.attr("length"),
                    ...
                    n = t.val().length;
                0 === t.val().length && t[0].validity.badInput === !1 ? t.hasClass("validate") && (t.removeClass("valid"), t.removeClass("invalid")) : t.hasClass("validate") && (t.is(":valid") && e && n <= i || t.is(":valid") && !e ? (t.removeClass("invalid"), t.addClass("valid")) : (t.removeClass("valid"), t.addClass("invalid")))
            };
            ...
            t(o).each(function() {
                ...
                for (var e = t(this).closest(".file-field"), i = e.find("input.file-path"), n = t(this)[0].files, o = [], s = 0; s < n.length; s++) o.push(n[s].name);
            ...
            t(document).on("change", a, function(e) {
                ...
                i.length <= 0 && (i = t('<span class="thumb"><span class="value"></span></span>'), t(this).after(i)), i.find(".value").html(t(this).val()), r = !0, t(this).addClass("active"), i.hasClass("active") || i.velocity({
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), "input" !== e.type && (s = void 0 === e.pageX || null === e.pageX ? e.originalEvent.touches[0].pageX - t(this).offset().left : e.pageX - t(this).offset().left, s < 0 ? s = 0 : s > n && (s = n), i.addClass("active").css("left", s)), i.find(".value").html(t(this).val())
                ...
                if (r) {
                    ...
                    i < 0 ? i = 0 : i > o && (i = o), n.addClass("active").css("left", i), n.find(".value").html(n.siblings(a).val())
                }
            ...
            function i(t, e, i) {
                var o = t.indexOf(e),
                    s = o === -1;
                return s ? t.push(e) : t.splice(o, 1), i.siblings("ul.dropdown-content").find("li").eq(e).toggleClass("active"), i.find("option").eq(e).prop("selected", s), n(t, i), s
            }
            ...
            t(this).each(function() {
                ...
                if (!n.hasClass("browser-default")) {
                    var o = !!n.attr("multiple"),
                        s = n.data("select-id");
                    if (s && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + s).remove()), "destroy" === e) return void n.data("select-id", null).removeClass("initialized");
                    ...
                    var l = t('<ul id="select-options-' + a + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'),
                        ...
                        p = function(e, i, n) {
                            ...
                            if (s) {
                                var r = "";
                                return a && (r = ' class="' + a + '"'), "multiple" === n ? l.append(t('<li class="' + o + '"><img src="' + s + '"' + r + '><span><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : l.append(t('<li class="' + o + '"><img src="' + s + '"' + r + "><span>" + i.html() + "</span></li>")), !0
                            }
                    ...
                    c.length && c.each(function() {
                        if (t(this).is("option")) o ? p(n, t(this), "multiple") : p(n, t(this));
                        ...
                        t(this).click(function(a) {
                            if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                ...
                                o ? (t('input[type="checkbox"]', this).prop("checked", function(t, e) {
                                    return !e
                                }), r = i(h, t(this).index(), n), v.trigger("focus")) : (l.find("li").removeClass("active"), t(this).toggleClass("active"), v.val(t(this).text())), activateOption(l, t(this)), n.find("option").eq(s).prop("selected", r), n.trigger("change"), "undefined" != typeof e && e()
                            }
                            a.stopPropagation()
                        })
                    }), n.wrap(r);
                    ...
                    var g = d.replace(/"/g, "&quot;"),
                        v = t('<input type="text" class="select-dropdown" readonly="true" ' + (n.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + a + '" value="' + g + '"/>');
                    n.before(v), v.before(f), v.after(l), n.is(":disabled") || v.dropdown({
                        hover: !1,
                        closeOnClick: !1
                    ...
                    var m = [],
                        y = function(e) {
                            ...
                            if (13 != e.which || l.is(":visible")) {
                                ...
                                40 == e.which && (a = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0], activateOption(l, a)), 27 == e.which && v.trigger("close"), 38 == e.which && (a = l.find("li.selected").prev("li:not(.disabled)")[0], a && activateOption(l, a)), setTimeout(function() {
                                    m = []
                                }, 1e3)
                            }
                        };
    ...
    function(t) {
        ...
        function e(s, a, l, d) {
            function p() {
                return e._.node("div", e._.node("div", e._.node("div", e._.node("div", A.component.nodes(S.open), C.box), C.wrap), C.frame), C.holder, 'tabindex="-1"')
            }

            function f() {
                P.data(a, A).addClass(C.input).val(P.data("value") ? A.get("select", k.format) : s.value), k.editable || P.on("focus." + S.id + " click." + S.id, function(t) {
                    t.preventDefault(), A.open()
                }).on("keydown." + S.id, w), o(s, {
                    haspopup: !0,
                    expanded: !1,
                    readonly: !1,
                    owns: s.id + "_root"
            ...
            function v() {
                A.$holder.on({
                    ...
                    "focus.toOpen": b,
                    blur: function() {
                        P.removeClass(C.target)
                    },
                    focusin: function(t) {
                        A.$root.removeClass(C.focused), t.stopPropagation()
                    },
                    "mousedown click": function(e) {
                        var i = e.target;
                        i != A.$holder[0] && (e.stopPropagation(), "mousedown" != e.type || t(i).is("input, select, textarea, button, option") || (e.preventDefault(), A.$holder[0].focus()))
                    }
                    ...
                    var e = t(this),
                        ...
                        o = r();
                    o = o && (o.type || o.href), (n || o && !t.contains(A.$root[0], o)) && A.$holder[0].focus(), !n && i.nav ? A.set("highlight", A.component.item.highlight, {
                        nav: i.nav
                    }) : !n && "pick" in i ? (A.set("select", i.pick), k.closeOnSelect && A.close(!0)) : i.clear ? (A.clear(), k.closeOnClear && A.close(!0)) : i.close && A.close(!0)
                })
            }

            function m() {
                var e;
                k.hiddenName === !0 ? (e = s.name, s.name = "") : (e = ["string" == typeof k.hiddenPrefix ? k.hiddenPrefix : "", "string" == typeof k.hiddenSuffix ? k.hiddenSuffix : "_submit"], e = e[0] + s.name + e[1]), A._hidden = t('<input type=hidden name="' + e + '"' + (P.data("value") || s.value ? ' value="' + A.get("select", k.formatSubmit) + '"' : "") + ">")[0], P.on("change." + S.id, function() {
                    A._hidden.value = s.value ? A.get("select", k.formatSubmit) : ""
                })
            }

            function y() {
                x && u ? A.$holder.find("." + C.frame).one("transitionend", function() {
                    A.$holder[0].focus()
                }) : A.$holder[0].focus()
            }

            function b(t) {
                t.stopPropagation(), P.addClass(C.target), A.$root.addClass(C.focused), A.open()
            }

            function w(t) {
                var e = t.keyCode,
                    i = /^(8|46)$/.test(e);
                return 27 == e ? (A.close(!0), !1) : void((32 == e || i || !S.open && A.component.key[e]) && (t.preventDefault(), t.stopPropagation(), i ? A.clear().close() : A.open()))
            }
            if (!s) return e;
            var x = !1,
                S = {
                ...
                k = l ? t.extend(!0, {}, l.defaults, d) : d || {},
                C = t.extend({}, e.klasses(), k.klass),
                P = t(s),
                T = function() {
                    return this.start()
                },
                A = T.prototype = {
                    ...
                    $node: P,
                    start: function() {
                        return S && S.start ? A : (S.methods = {}, S.start = !0, S.open = !1, S.type = s.type, s.autofocus = s == r(), s.readOnly = !k.editable, s.id = s.id || S.id, "text" != s.type && (s.type = "text"), A.component = new l(A, k), A.$root = t('<div class="' + C.picker + '" id="' + s.id + '_root" />'), g(), A.$holder = t(p()).appendTo(A.$root), v(), k.formatSubmit && m(), f(), k.containerHidden ? t(k.containerHidden).append(A._hidden) : P.after(A._hidden), k.container ? t(k.container).append(A.$root) : P.after(A.$root), A.on({
                            ...
                            close: k.onClose,
                            set: k.onSet
                        }), x = i(A.$holder[0]), s.autofocus && A.open(), A.trigger("start").trigger("render"))
                    },
                    render: function(e) {
                        return e ? (A.$holder = t(p()), v(), A.$root.html(A.$holder)) : A.$root.find("." + C.box).html(A.component.nodes(S.open)), A.trigger("render")
                    },
                    stop: function() {
                        return S.start ? (A.close(), A._hidden && A._hidden.parentNode.removeChild(A._hidden), A.$root.remove(), P.removeClass(C.input).removeData(a), setTimeout(function() {
                            P.off("." + S.id)
                        }, 0), s.type = S.type, s.readOnly = !1, A.trigger("stop"), S.methods = {}, S.start = !1, A) : A
                    },
                    open: function(i) {
                        return S.open ? A : (P.addClass(C.active), o(s, "expanded", !0), setTimeout(function() {
                            A.$root.addClass(C.opened), o(A.$root[0], "hidden", !1)
                        }, 0), i !== !1 && (S.open = !0, x && h.css("overflow", "hidden").css("padding-right", "+=" + n()), y(), c.on("click." + S.id + " focusin." + S.id, function(t) {
                            var e = t.target;
                            e != s && e != document && 3 != t.which && A.close(e === A.$holder[0])
                        }).on("keydown." + S.id, function(i) {
                            var n = i.keyCode,
                                o = A.component.key[n],
                                s = i.target;
                            27 == n ? A.close(!0) : s != A.$holder[0] || !o && 13 != n ? t.contains(A.$root[0], s) && 13 == n && (i.preventDefault(), s.click()) : (i.preventDefault(), o ? e._.trigger(A.component.key.go, A, [e._.trigger(o)]) : A.$root.find("." + C.highlighted).hasClass(C.disabled) || (A.set("select", A.component.item.highlight), k.closeOnSelect && A.close(!0)))
                        })), A.trigger("open"))
                    },
                    close: function(t) {
                        return t && (k.editable ? s.focus() : (A.$holder.off("focus.toOpen").focus(), setTimeout(function() {
                            A.$holder.on("focus.toOpen", b)
                        }, 0))), P.removeClass(C.active), o(s, "expanded", !1), setTimeout(function() {
                            A.$root.removeClass(C.opened + " " + C.focused), o(A.$root[0], "hidden", !0)
                        }, 0), S.open ? (S.open = !1, x && h.css("overflow", "").css("padding-right", "-=" + n()), c.off("." + S.id), A.trigger("close")) : A
                    },
                    clear: function(t) {
                        return A.set("clear", null, t)
                    },
                    set: function(e, i, n) {
                        var o, s, a = t.isPlainObject(e),
                            r = a ? e : {};
                        if (n = a && t.isPlainObject(i) ? i : n || {}, e) {
                            a || (r[e] = i);
                            for (o in r) s = r[o], o in A.component.item && (void 0 === s && (s = null), A.component.set(o, s, n)), "select" != o && "clear" != o || P.val("clear" == o ? "" : A.get(o, k.format)).trigger("change");
                            A.render()
                        }
                        return n.muted ? A : A.trigger("set", r)
                    },
                    get: function(t, i) {
                        if (t = t || "value", null != S[t]) return S[t];
                        if ("valueSubmit" == t) {
                        ...
                        if (t in A.component.item) {
                            if ("string" == typeof i) {
                                var n = A.component.get(t);
                                return n ? e._.trigger(A.component.formats.toString, A.component, [i, n]) : ""
                            }
                    ...
                    on: function(e, i, n) {
                        ...
                        if (e) {
                            a || (r[e] = i);
                            for (o in r) s = r[o], n && (o = "_" + o), S.methods[o] = S.methods[o] || [], S.methods[o].push(s)
                        }
                        return A
                    },
                    off: function() {
                        var t, e, i = arguments;
                        for (t = 0, namesCount = i.length; t < namesCount; t += 1) e = i[t], e in S.methods && delete S.methods[e];
                        return A
                    },
        ...
        return e.klasses = function(t) {
            ...
            t.fn[i] = function(o, s) {
                var a = this.data(i);
                return "picker" == o ? a : a && "string" == typeof o ? e._.trigger(a[o], a, [s]) : this.each(function() {
                    var s = t(this);
    ...
    function(t) {
        ...
        i.prototype.set = function(t, e, i) {
            ...
            var o, a = this;
            return i = void 0 === i ? t : i, i == -(1 / 0) || i == 1 / 0 ? o = i : e.isPlainObject(i) && s.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0], i[1], i[2]), i = s.isDate(i) ? i : a.create().obj) : i = s.isInteger(i) || s.isDate(i) ? a.normalize(new Date(i), n) : a.now(t, i, n), {
            ...
            var o, s, a, r, l = e.isArray(i),
                c = e.isPlainObject(i),
                h = this.item.view;
            if (l || c) {
                for (c ? (s = i.year, a = i.month, r = i.date) : (s = +i[0], a = +i[1], r = +i[2]), n && n.nav && h && h.month !== a && (s = h.year, a = h.month), o = new Date(s, a + (n && n.nav ? n.nav : 0), 1), s = o.getFullYear(), a = o.getMonth(); new Date(s, a, r).getMonth() !== a;) r -= 1;
                i = [s, a, r]
            }
            return i
            ...
            var o, a, r, l, c = this,
                ...
                g = d && c.item.disable.filter(function(t) {
                    if (e.isArray(t)) {
                        ...
                        n < i.pick ? o = !0 : n > i.pick && (a = !0)
                    }
                    return s.isInteger(t)
                }).length;
            if ((!n || !n.nav && !n.defaultValue) && (!d && c.disabled(i) || d && c.disabled(i) && (g || o || a) || !d && (i.pick <= p.pick || i.pick >= f.pick)))
                for (d && !g && (!a && u > 0 || !o && u < 0) && (u *= -1); c.disabled(i) && (Math.abs(u) > 1 && (i.month < h.month || i.month > h.month) && (i = h, u = u > 0 ? 1 : -1), i.pick <= p.pick ? (r = !0, u = 1, i = c.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : -1)])) : i.pick >= f.pick && (l = !0, u = -1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : 1)])), !r || !l);) i = c.create([i.year, i.month, i.date + u]);
            return i
            ...
            return e && "string" == typeof e ? (i && i.format || (i = i || {}, i.format = n.settings.format), n.formats.toArray(i.format).map(function(t) {
                var i = n.formats[t],
                    a = i ? s.trigger(i, n, [e, o]) : t.replace(/^!/, "").length;
            ...
            return s.isInteger(t) && (s.isDate(i) || e.isArray(i)) ? (t = t % 7 + o, t === n.create(i).day + 1) : s.isInteger(i) && (s.isDate(t) || e.isArray(t)) ? (i = i % 7 + o, i === n.create(t).day + 1) : !(!e.isPlainObject(t) || !e.isPlainObject(i)) && n.overlapRanges(t, i)
            ...
            var e = this,
                ...
                g = function(t) {
                    return s.node("div", " ", i.klass["nav" + (t ? "Next" : "Prev")] + (t && h.year >= p.year && h.month >= p.month || !t && h.year <= d.year && h.month <= d.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + s.ariaAttr({
                        role: "button",
                ...
                v = function() {
                    ...
                    return i.selectMonths ? s.node("select", s.group({
                        ...
                        node: "option",
                        item: function(t) {
                            return [n[t], 0, "value=" + t + (h.month == t ? " selected" : "") + (h.year == d.year && t < d.month || h.year == p.year && t > p.month ? " disabled" : "")]
                        }
                    }), i.klass.selectMonth, (t ? "" : "disabled") + " " + s.ariaAttr({
                        controls: e.$node[0].id + "_table"
                    }) + ' title="' + i.labelMonthSelect + '"') : s.node("div", n[h.month], i.klass.month)
                },
                m = function() {
                    var n = h.year,
            ...
            return s.node("div", (i.selectYears ? m() + v() : v() + m()) + g() + g(1), i.klass.header) + s.node("table", f + s.node("tbody", s.group({
                min: 0,
                max: o - 1,
                i: 1,
                node: "tr",
                item: function(t) {
                    var o = i.firstDay && 0 === e.create([h.year, h.month, 1]).day ? -7 : 0;
                    return [s.group({
                        min: n * t - h.day + o + 1,
                        max: function() {
                            return this.min + n - 1
                        ...
                        node: "td",
                        item: function(t) {
                            t = e.create([h.year, h.month, t + (i.firstDay ? 1 : 0)]);
                            var n = l && l.pick == t.pick,
                                o = c && c.pick == t.pick,
                                a = u && e.disabled(t) || t.pick < d.pick || t.pick > p.pick,
                                f = s.trigger(e.formats.toString, e, [i.format, t]);
                            return [s.node("div", t.date, function(e) {
                                return e.push(h.month == t.month ? i.klass.infocus : i.klass.outfocus), r.pick == t.pick && e.push(i.klass.now), n && e.push(i.klass.selected), o && e.push(i.klass.highlighted), a && e.push(i.klass.disabled), e.join(" ")
                ...
                readonly: !0
            })) + s.node("div", s.node("button", i.today, i.klass.buttonToday, "type=button data-pick=" + r.pick + (t && !e.disabled(r) ? "" : " disabled") + " " + s.ariaAttr({
                controls: e.$node[0].id
    ...
    function() {
        ...
        function n(n, a) {
            function l(t, e) {
                var i = u.offset(),
                    ...
                    h = (n ? t.originalEvent.touches[0] : t).pageY - s,
                    d = Math.sqrt(l * l + h * h),
                    g = !1;
                if (!e || !(d < y - w || d > y + w)) {
                    t.preventDefault();
                    var v = setTimeout(function() {
                        L.popover.addClass("clockpicker-moving")
                    }, 200);
                    c && u.append(L.canvas), L.setHand(l, h, !e, !0), r.off(p).on(p, function(t) {
                        t.preventDefault();
                        var e = /^touch/.test(t.type),
                            i = (e ? t.originalEvent.touches[0] : t).pageX - o,
                            n = (e ? t.originalEvent.touches[0] : t).pageY - s;
                        (g || i !== l || n !== h) && (g = !0, L.setHand(i, n, !1, !0))
                    }), r.off(f).on(f, function(t) {
                        r.off(f), t.preventDefault();
                        var i = /^touch/.test(t.type),
                            n = (i ? t.originalEvent.changedTouches[0] : t).pageX - o,
                            c = (i ? t.originalEvent.changedTouches[0] : t).pageY - s;
                        (e || g) && n === l && c === h && L.setHand(n, c), "hours" === L.currentView ? L.toggleView("minutes", S / 2) : a.autoclose && (L.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() {
                            L.done()
                        }, S / 2)), u.prepend(X), clearTimeout(v), L.popover.removeClass("clockpicker-moving"), r.off(p)
                    })
                }
            }
            var h = s(k),
                u = h.find(".clockpicker-plate"),
                g = h.find(".picker__holder"),
                v = h.find(".clockpicker-hours"),
                C = h.find(".clockpicker-minutes"),
                P = h.find(".clockpicker-am-pm-block"),
                T = "INPUT" === n.prop("tagName"),
                A = T ? n : n.find("input"),
                E = s("label[for=" + A.attr("id") + "]"),
                L = this;
            if (this.id = i("cp"), this.element = n, this.holder = g, this.options = a, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = T, this.input = A, this.label = E, this.popover = h, this.plate = u, this.hoursView = v, this.minutesView = C, this.amPmBlock = P, this.spanHours = h.find(".clockpicker-span-hours"), this.spanMinutes = h.find(".clockpicker-span-minutes"), this.spanAmPm = h.find(".clockpicker-span-am-pm"), this.footer = h.find(".picker__footer"), this.amOrPm = "PM", a.twelvehour) {
                ...
                s(M);
                a.ampmclickable ? (this.spanAmPm.empty(), s('<div id="click-am">AM</div>').on("click", function() {
                    L.spanAmPm.children("#click-am").addClass("text-primary"), L.spanAmPm.children("#click-pm").removeClass("text-primary"), L.amOrPm = "AM"
                }).appendTo(this.spanAmPm), s('<div id="click-pm">PM</div>').on("click", function() {
                    L.spanAmPm.children("#click-pm").addClass("text-primary"), L.spanAmPm.children("#click-am").removeClass("text-primary"), L.amOrPm = "PM"
                }).appendTo(this.spanAmPm)) : (s('<button type="button" class="btn-floating btn-flat clockpicker-button am-button" tabindex="1">AM</button>').on("click", function() {
                    L.amOrPm = "AM", L.amPmBlock.children(".pm-button").removeClass("active"), L.amPmBlock.children(".am-button").addClass("active"), L.spanAmPm.empty().append("AM")
                }).appendTo(this.amPmBlock), s('<button type="button" class="btn-floating btn-flat clockpicker-button pm-button" tabindex="2">PM</button>').on("click", function() {
                    L.amOrPm = "PM", L.amPmBlock.children(".am-button").removeClass("active"), L.amPmBlock.children(".pm-button").addClass("active"), L.spanAmPm.empty().append("PM")
                }).appendTo(this.amPmBlock))
            }
            a.darktheme && h.addClass("darktheme"), s('<button type="button" class="btn-flat clockpicker-button" tabindex="' + (a.twelvehour ? "3" : "1") + '">' + a.donetext + "</button>").click(s.proxy(this.done, this)).appendTo(this.footer), this.spanHours.click(s.proxy(this.toggleView, this, "hours")), this.spanMinutes.click(s.proxy(this.toggleView, this, "minutes")), A.on("focus.clockpicker click.clockpicker", s.proxy(this.show, this));
            var R, O, W, F, I = s('<div class="clockpicker-tick"></div>');
            if (a.twelvehour)
                for (R = 1; R < 13; R += 1) O = I.clone(), W = R / 6 * Math.PI, F = y, O.css("font-size", "140%"), O.css({
                    left: m + Math.sin(W) * F - w,
                    top: m - Math.cos(W) * F - w
                }), O.html(0 === R ? "00" : R), v.append(O), O.on(d, l);
            else
                for (R = 0; R < 24; R += 1) {
                    O = I.clone(), W = R / 6 * Math.PI;
                    var D = R > 0 && R < 13;
                    F = D ? b : y, O.css({
                        left: m + Math.sin(W) * F - w,
                        top: m - Math.cos(W) * F - w
                    }), D && O.css("font-size", "120%"), O.html(0 === R ? "00" : R), v.append(O), O.on(d, l)
                }
            for (R = 0; R < 60; R += 5) O = I.clone(), W = R / 30 * Math.PI, O.css({
                left: m + Math.sin(W) * y - w,
                top: m - Math.cos(W) * y - w
            }), O.css("font-size", "140%"), O.html(e(R)), C.append(O), O.on(d, l);
            if (u.on(d, function(t) {
                    0 === s(t.target).closest(".clockpicker-tick").length && l(t, !0)
                }), c) {
                var X = h.find(".clockpicker-canvas"),
                    Y = t("svg");
                Y.setAttribute("class", "clockpicker-svg"), Y.setAttribute("width", x), Y.setAttribute("height", x);
                var z = t("g");
                z.setAttribute("transform", "translate(" + m + "," + m + ")");
                var V = t("circle");
                ...
                var B = t("circle");
                B.setAttribute("class", "clockpicker-canvas-fg"), B.setAttribute("r", 5), z.appendChild(H), z.appendChild(j), z.appendChild(B), z.appendChild(V), Y.appendChild(z), X.append(Y), this.hand = H, this.bg = j, this.fg = B, this.bearing = V, this.g = z, this.canvas = X
            }
            o(this.options.init)
        }
        ...
        n.DEFAULTS = {
            ...
            if (!this.isShown) {
                o(this.options.beforeShow), s(":input").each(function() {
                    s(this).attr("tabindex", -1)
                });
                var i = this;
                this.input.blur(), this.popover.addClass("picker--opened"), this.input.addClass("picker__input picker__input--active"), s(document.body).css("overflow", "hidden"), this.isAppended || (this.popover.insertAfter(this.input), this.options.twelvehour && (this.amOrPm = "PM", this.options.ampmclickable ? (this.spanAmPm.children("#click-pm").addClass("text-primary"), this.spanAmPm.children("#click-am").removeClass("text-primary")) : (this.amPmBlock.children(".am-button").removeClass("active"), this.amPmBlock.children(".pm-button").addClass("active"), this.spanAmPm.empty().append("PM"))), a.on("resize.clockpicker" + this.id, function() {
                    i.isShown && i.locate()
                }), this.isAppended = !0);
                var n = ((this.input.prop("value") || this.options.default || "") + "").split(":");
                if (this.options.twelvehour && "undefined" != typeof n[1] && (n[1] = n[1].replace("AM", "").replace("PM", "")), "now" === n[0]) {
            ...
            o(this.options.beforeHide), this.input.removeClass("picker__input picker__input--active"), this.popover.removeClass("picker--opened"), s(document.body).css("overflow", "visible"), this.isShown = !1, s(":input").each(function(t) {
            ...
            var i = !1;
            "minutes" === t && "visible" === s(this.hoursView).css("visibility") && (o(this.options.beforeHourSelect), i = !0);
            var n = "hours" === t,
                a = n ? this.hoursView : this.minutesView,
                r = n ? this.minutesView : this.hoursView;
            this.currentView = t, this.spanHours.toggleClass("text-primary", n), this.spanMinutes.toggleClass("text-primary", !n), r.addClass("clockpicker-dial-out"), a.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(e), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function() {
            ...
            var e = this.currentView,
                ...
                l = -Math.cos(s) * a,
                h = this;
            c && t ? (h.canvas.addClass("clockpicker-canvas-out"), setTimeout(function() {
                h.canvas.removeClass("clockpicker-canvas-out"), h.setHand(r, l)
            }, t)) : this.setHand(r, l)
        }, n.prototype.setHand = function(t, i, n, o) {
            var a, r = Math.atan2(t, -i),
                ...
                p = l && u < (y + b) / 2,
                f = p ? b : y;
            if (d.twelvehour && (f = y), r < 0 && (r = 2 * Math.PI + r), a = Math.round(r / h), r = a * h, d.twelvehour ? l ? 0 === a && (a = 12) : (n && (a *= 5), 60 === a && (a = 0)) : l ? (12 === a && (a = 0), a = p ? 0 === a ? 12 : a : 0 === a ? 0 : a + 12) : (n && (a *= 5), 60 === a && (a = 0)), l ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : a % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== a && g && this.options.vibrate && (this.vibrateTimer || (navigator[g](10), this.vibrateTimer = setTimeout(s.proxy(function() {
            ...
            var v = Math.sin(r) * (f - w),
                m = -Math.cos(r) * (f - w),
                x = Math.sin(r) * f,
                S = -Math.cos(r) * f;
            this.hand.setAttribute("x2", v), this.hand.setAttribute("y2", m), this.bg.setAttribute("cx", x), this.bg.setAttribute("cy", S), this.fg.setAttribute("cx", x), this.fg.setAttribute("cy", S)
            ...
            return this.each(function() {
                ...
                if (o) "function" == typeof o[t] && o[t].apply(o, e);
                    ...
                    var a = s.extend({}, n.DEFAULTS, i.data(), "object" == typeof t && t);
